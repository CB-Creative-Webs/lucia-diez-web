...
const homeTranslations = {
  es: {
    ...
    selectorText: {
      ...
      ".service-option:nth-child(1) .price-row strong": "Argentina $280.000 ARS",
      ".service-option:nth-child(1) .price-row small": "Exterior USD 320 · se desarrolla durante 3 meses",
      ...
      ".service-option:nth-child(2) .price-row strong": "Argentina $70.000 ARS",
      ".service-option:nth-child(2) .price-row small": "Exterior USD 80 · por sesión",
  ...
  en: {
    ...
    selectorText: {
      ...
      ".service-option:nth-child(1) .price-row strong": "Argentina ARS $280,000",
      ".service-option:nth-child(1) .price-row small": "International USD 320 · runs over 3 months",
      ...
      ".service-option:nth-child(2) .price-row strong": "Argentina ARS $70,000",
      ".service-option:nth-child(2) .price-row small": "International USD 80 · per session",
